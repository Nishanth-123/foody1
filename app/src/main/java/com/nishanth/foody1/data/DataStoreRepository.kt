...
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_BACK_ONLINE
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_DIET_TYPE
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_DIET_TYPE_ID
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_MEAL_TYPE
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_MEAL_TYPE_ID
import com.nishanth.foody1.util.Constants.Companion.PREFERENCES_NAME
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val readBackOnline = dataStore.data
        .catch { exception ->
            if (exception is IOException) {
                emit(emptyPreferences())
            } else {
